...
Schéma d'architecture réseau : Le diagramme suivant détaille la connectivi<img width="806" height="902" alt="schema" src="https://github.com/user-attachments/assets/54ab928b-6512-4678-91d1-f7214a9e4c0b" />
té entre le nœud Admin, le cluster RedHat, le contrôleur de domaine Windows et les flux de supervision Zabbix.
<img width="957" height="556" alt="zabbix" src="https://github.com/user-attachments/assets/406d7256-ee8b-4043-8c92-994072be34fc" />
